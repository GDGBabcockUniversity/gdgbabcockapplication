...
const DEV_TEAM_ROLES = [
  ...
  },
  {
    ...
    mandate: "Move the Data",
    purpose: "Build and maintain the pipelines that collect, clean, and store data across GDG Babcock products. Make sure the numbers the team reports on are reliable, current, and actually queryable.",
    responsibilities: [
      "Build and maintain ETL pipelines that move data from community products into a central store",
      "Model and document datasets so analysts and scientists can work without guesswork",
      "Automate ingestion, validation, and scheduled refreshes; monitor pipelines and fix breakages",
      "Optimize storage and queries for cost and speed as data volume grows",
      "Partner with Backend Specialists on event tracking, schemas, and data contracts",
      "Write clear documentation for datasets, lineage, and pipeline runbooks",
    ],
    requirements: [
      "Comfortable with SQL and a scripting language for data work (Python preferred)",
      "Understanding of relational databases, schema design, and basic data modeling",
      "Familiarity with ETL concepts — batch jobs, scheduling, incremental loads",
      "Willingness to learn cloud data tooling (BigQuery, Airflow, dbt, or similar)",
    ],
    panelLooksFor: [
      "Evidence of hands-on data work — pipelines, scrapers, notebooks, or side projects",
      "Rigor about correctness — you validate data instead of assuming it's clean",
      "Systems thinking about reliability, idempotency, and failure recovery",
      "Ability to explain a pipeline's shape and tradeoffs clearly",
      "Collaboration with the people downstream who consume what you build",
    ],
    color: "#4285F4",
  },
  {
    title: "Data Analysis Specialist",
    mandate: "Turn Data Into Decisions",
    purpose: "Answer real questions about how the community uses our products. Build dashboards, run analyses, and turn raw numbers into recommendations the team can act on.",
    responsibilities: [
      "Analyze product and community data to surface usage patterns, drop-offs, and opportunities",
      "Build and maintain dashboards that leadership and product owners actually check",
      "Define and track the metrics that matter for community products and events",
      "Translate open-ended questions into concrete analyses with clear, honest conclusions",
      "Present findings to non-technical stakeholders with visualizations that make the point",
      "Document assumptions, data sources, and caveats so results can be trusted and reproduced",
    ],
    requirements: [
      "Strong SQL and comfort working with spreadsheets or a BI tool",
      "Familiarity with Python or R for analysis (pandas, notebooks, or equivalent)",
      "Understanding of descriptive statistics and how to avoid misreading data",
      "Ability to build clear charts and explain what they do and don't show",
    ],
    panelLooksFor: [
      "Past analyses, dashboards, or write-ups where you drew a conclusion from data",
      "Curiosity about the 'why' behind a number, not just the number",
      "Intellectual honesty about uncertainty, sample size, and confounders",
      "Communication that lands with non-technical audiences",
      "Practical instinct for which questions are worth the analysis",
    ],
    color: "#EA4335",
  },
  {
    title: "Data Science Specialist",
    mandate: "Model What Matters",
    purpose: "Apply statistical and machine learning methods to problems facing the campus community. Take a question from framing through modeling to a result the team can use.",
    responsibilities: [
      "Frame community and product problems as tractable modeling or statistical questions",
      "Build, evaluate, and iterate on models — regression, classification, clustering, forecasting",
      "Run experiments and A/B tests, and interpret results with appropriate rigor",
      "Do exploratory analysis and feature engineering on datasets from the data pipelines",
      "Work with AI/ML and Data Engineering Specialists to move promising models toward production",
      "Document methodology, assumptions, and limitations so work can be reviewed and reproduced",
    ],
    requirements: [
      "Working knowledge of Python for data science (pandas, scikit-learn, numpy, or similar)",
      "Understanding of core statistics — distributions, hypothesis testing, correlation vs. causation",
      "Familiarity with the model lifecycle: train, validate, evaluate, iterate",
      "Comfort with notebooks, version control, and communicating results",
    ],
    panelLooksFor: [
      "Projects, notebooks, or competitions showing an end-to-end modeling process",
      "Sound evaluation habits — proper splits, sensible metrics, skepticism about good results",
      "Ability to explain why a method fits the problem, not just that it worked",
      "Awareness of bias, fairness, and the limits of a model's conclusions",
      "Willingness to ship something useful rather than chase marginal accuracy",
    ],
    color: "#34A853",
  },
  {
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          {!isExpired && (
            <>
              ...
              <p className="text-sm text-white/25 font-mono mb-12">Applications close August 19, 2026 at 11:59 PM</p>
            </>
          )}
